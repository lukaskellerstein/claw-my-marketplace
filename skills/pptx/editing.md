...
```bash
python3 {baseDir}/../pptx/scripts/thumbnail.py template.pptx thumbnails/
```
...
```bash
python3 {baseDir}/../_office-shared/scripts/office/unpack.py template.pptx template_unpacked/
```
...
```bash
python3 {baseDir}/../pptx/scripts/add_slide.py template_unpacked/ 2
```
...
```bash
python3 {baseDir}/../pptx/scripts/clean.py template_unpacked/
```
...
```bash
python3 {baseDir}/../_office-shared/scripts/office/pack.py template_unpacked/ output.pptx
```
...
python3 {baseDir}/../_office-shared/scripts/office/validate.py output.pptx --original template.pptx -v
