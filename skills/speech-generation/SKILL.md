...
metadata: {"openclaw": {"requires": {"bins": ["uv"], "env": ["ELEVENLABS_API_KEY"]}, "primaryEnv": "ELEVENLABS_API_KEY"}}
---
...
|---------------------|-----------|---------------------|
| Product demo / explainer video | [voiceover.md]({baseDir}/../speech-generation/references/voiceover.md) | Product Demo or Explainer Video |
| Marketing / promo voiceover | [voiceover.md]({baseDir}/../speech-generation/references/voiceover.md) | Marketing / Promo |
| Audiobook / fiction | [narration.md]({baseDir}/../speech-generation/references/narration.md) | Fiction / Audiobook |
| Documentary narration | [narration.md]({baseDir}/../speech-generation/references/narration.md) | Documentary |
| Technical tutorial audio | [documentation.md]({baseDir}/../speech-generation/references/documentation.md) | Technical Tutorial |
| README / docs narration | [documentation.md]({baseDir}/../speech-generation/references/documentation.md) | README Narration |
| Podcast episode | [podcast.md]({baseDir}/../speech-generation/references/podcast.md) | Conversational Host |
| IVR / phone menu | [announcement.md]({baseDir}/../speech-generation/references/announcement.md) | IVR / Phone Menu |
| App notification sound | [announcement.md]({baseDir}/../speech-generation/references/announcement.md) | App Notification |
| Multi-language content | [multilingual.md]({baseDir}/../speech-generation/references/multilingual.md) | — |
| Custom parameter tuning | [voice-settings.md]({baseDir}/../speech-generation/references/voice-settings.md) | See Named Presets table |
...
For detailed model comparison and selection guidance, see [voice-settings.md]({baseDir}/../speech-generation/references/voice-settings.md).
...
Controls are summarized below. For parameter interaction details, named presets, and advanced tuning, see [voice-settings.md]({baseDir}/../speech-generation/references/voice-settings.md).
...
For platform-specific format recommendations, see [announcement.md]({baseDir}/../speech-generation/references/announcement.md).

## Common Patterns

### Documentation narration
See [documentation.md]({baseDir}/../speech-generation/references/documentation.md) for text cleaning, code block handling, and segmentation.
```
...
### Video voiceover
See [voiceover.md]({baseDir}/../speech-generation/references/voiceover.md) for timing tables, text prep, ffmpeg mixing, the timed voiceover pipeline, and golden rules.
```
...
See [announcement.md]({baseDir}/../speech-generation/references/announcement.md) for brevity rules, templates, and platform formats.
```
...
### Story / narrative
See [narration.md]({baseDir}/../speech-generation/references/narration.md) for character voices, long-form strategy, and pacing.
```
text: [story content]
voice_name: "Rachel"
model_id: "eleven_v3"
...
### Multi-language
See [multilingual.md]({baseDir}/../speech-generation/references/multilingual.md) for language tiers, pronunciation hints, and batch workflows.
...
See [podcast.md]({baseDir}/../speech-generation/references/podcast.md) for multi-speaker workflow, voice pairing, and episode structure.
...
See [podcast.md]({baseDir}/../speech-generation/references/podcast.md) for the complete step-by-step workflow.
...
- For advanced parameter tuning, consult [voice-settings.md]({baseDir}/../speech-generation/references/voice-settings.md)
- For video voiceover, follow the [Golden Rules]({baseDir}/../speech-generation/references/voiceover.md#golden-rules-for-video-voiceover) and [Timed Voiceover Pipeline]({baseDir}/../speech-generation/references/voiceover.md#timed-voiceover-pipeline)
- Check [voice tiers]({baseDir}/../speech-generation/references/voice-settings.md#voice-tiers--api-access) before selecting a voice — library/cloned voices need a paid plan
- Use the [Voice Selection Guide]({baseDir}/../speech-generation/references/voiceover.md#voice-selection-guide) to match voice type to content — always test the voice before writing the full script

## Reference Files

| File | What It Covers | When to Read |
|------|---------------|--------------|
| [voice-settings.md]({baseDir}/../speech-generation/references/voice-settings.md) | Parameter interactions, named presets, model selection, output formats | Tuning voice parameters or choosing a model |
| [voiceover.md]({baseDir}/../speech-generation/references/voiceover.md) | Product demos, explainers, marketing, corporate training | Creating audio for video content |
| [narration.md]({baseDir}/../speech-generation/references/narration.md) | Audiobooks, fiction, documentaries, children's stories | Long-form narrative or character voices |
| [documentation.md]({baseDir}/../speech-generation/references/documentation.md) | Tutorials, READMEs, API docs, e-learning | Converting technical docs to audio |
| [podcast.md]({baseDir}/../speech-generation/references/podcast.md) | Multi-speaker, interviews, episode structure | Podcast or dialogue production |
| [announcement.md]({baseDir}/../speech-generation/references/announcement.md) | IVR, notifications, system alerts, public address | Short-form announcements or telephony |
| [multilingual.md]({baseDir}/../speech-generation/references/multilingual.md) | Language support, pronunciation, localization | Non-English or multi-language content |
