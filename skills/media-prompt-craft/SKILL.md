...
See [references/search-strategy.md]({baseDir}/../media-prompt-craft/references/search-strategy.md) for advanced query patterns.
...
See [references/style-vocabulary.md]({baseDir}/../media-prompt-craft/references/style-vocabulary.md) for the comprehensive vocabulary. Key terms:
