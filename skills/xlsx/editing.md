...
```bash
python3 {baseDir}/../xlsx/scripts/preview.py input.xlsx --formulas
```
...
```bash
# Preview output
python3 {baseDir}/../xlsx/scripts/preview.py output.xlsx --formulas --errors-only
...
```bash
python3 {baseDir}/../_office-shared/scripts/office/unpack.py input.xlsx xlsx_unpacked/
```
...
```bash
# Pack
python3 {baseDir}/../_office-shared/scripts/office/pack.py xlsx_unpacked/ output.xlsx --validate
