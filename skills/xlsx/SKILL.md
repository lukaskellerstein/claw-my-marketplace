...
| Financial models | [references/financial-modeling.md]({baseDir}/../xlsx/references/financial-modeling.md) |
| openpyxl API | [references/openpyxl-api.md]({baseDir}/../xlsx/references/openpyxl-api.md) |
...
5. **Financial model?** — if yes, read [references/financial-modeling.md]({baseDir}/../xlsx/references/financial-modeling.md)
...
Read [references/openpyxl-api.md]({baseDir}/../xlsx/references/openpyxl-api.md) for the full API reference.
...
```bash
python3 {baseDir}/../xlsx/scripts/recalc.py output.xlsx
```
...
```bash
python3 {baseDir}/../xlsx/scripts/preview.py output.xlsx --formulas
```
...
```bash
python3 {baseDir}/../_office-shared/scripts/office/validate.py output.xlsx -v
```
...
```bash
python3 {baseDir}/../xlsx/scripts/preview.py file.xlsx --rows 20 --formulas
```
...
|--------|---------|-------|
| `soffice.py` | LibreOffice integration (convert, env) | `python3 {baseDir}/../_office-shared/scripts/office/soffice.py input.xlsx output.pdf` |
| `validate.py` | XSD schema + structural validation | `python3 {baseDir}/../_office-shared/scripts/office/validate.py input.xlsx [-v]` |
| `unpack.py` | Extract XLSX ZIP, pretty-print XML | `python3 {baseDir}/../_office-shared/scripts/office/unpack.py input.xlsx [output_dir]` |
| `pack.py` | Repack directory into XLSX ZIP | `python3 {baseDir}/../_office-shared/scripts/office/pack.py unpacked_dir [output.xlsx] [--validate]` |

### XLSX-Specific Scripts

| Script | Purpose | Usage |
|--------|---------|-------|
| `recalc.py` | Recalculate formulas via LibreOffice | `python3 {baseDir}/../xlsx/scripts/recalc.py input.xlsx [timeout]` |
| `preview.py` | Terminal-friendly spreadsheet preview | `python3 {baseDir}/../xlsx/scripts/preview.py input.xlsx [--rows N] [--formulas] [--json]` |

## Reference Files

| File | When to Read |
|------|-------------|
| [references/openpyxl-api.md]({baseDir}/../xlsx/references/openpyxl-api.md) | Always — openpyxl API quick reference |
| [references/financial-modeling.md]({baseDir}/../xlsx/references/financial-modeling.md) | When building financial models |
