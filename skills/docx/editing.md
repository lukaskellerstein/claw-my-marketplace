...
```bash
python3 {baseDir}/../docx/scripts/thumbnail.py document.docx thumbnails
```
...
```bash
# Basic unpack
python3 {baseDir}/../_office-shared/scripts/office/unpack.py document.docx doc_unpacked/

# With run merging (makes XML much cleaner for editing)
python3 {baseDir}/../_office-shared/scripts/office/unpack.py document.docx doc_unpacked/ --merge-runs

# With tracked change simplification
python3 {baseDir}/../_office-shared/scripts/office/unpack.py document.docx doc_unpacked/ --merge-runs --simplify-redlines
```
...
```bash
python3 {baseDir}/../docx/scripts/comment.py doc_unpacked/ "Comment text" --author "Claude"
```
...
```bash
# Basic pack
python3 {baseDir}/../_office-shared/scripts/office/pack.py doc_unpacked/ output.docx

# Pack with validation
python3 {baseDir}/../_office-shared/scripts/office/pack.py doc_unpacked/ output.docx --validate --original document.docx
```
...
python3 {baseDir}/../_office-shared/scripts/office/validate.py output.docx --original document.docx -v
...
```bash
python3 {baseDir}/../docx/scripts/accept_changes.py document.docx clean.docx
```
